...
export const suggestions: suggestionType[] = [
  ...
  },
  {
    id: 4,
    name: "Indian History",
    icon: "https://upload.wikimedia.org/wikipedia/en/archive/4/41/20230723002235%21Flag_of_India.svg",
  },
];
...
export const getSystemPrompt = (
  ...
  <teaching_info>
  ${Array.isArray(finalResults) ? finalResults.slice(0, 6).map((result, index) => `## Webpage #${index}:\n ${result.fullContent} \n\n`) : ""}
